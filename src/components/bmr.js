...
class bmr extends Component {
    ...
    calculateBMR() {
        ...
        let heightCenti = this.state.heightCm;
        ...
        if (this.state.calculationType == "imperial") {
        ...
        else if (this.state.calculationType == "metric") {
            ...
            */
            ...
            if (gender == 2) {
                //Calculation of Male BMR
                bmrCalc = 66.5 + (13.5 * weight) + (12.7 * heightCenti) - (6.755 * age);
            } else if (gender == 1) {
                //Calculation of Female BMR
                bmrCalc = 655 + (9.563 * weight) + (1.850 * heightCenti) - (4.676 * age);
            }
            this.setState({ bmr: bmrCalc });
        ...
        if (this.state.calculationType == "imperial") {
            ...
            metricForm = <div>
                ...
                <div className="inputwrap">
                    ...
                    <input type="number" value={this.state.heightCm} onChange={this.handleHeightCmChange} name="heightCm" className="heightCm" min="0" />
                </div>
                <div className="inputwrap">
                    <label className="label">Age in years</label>
                    <input type="number" value={this.state.age} onChange={this.handleAgeChange} className="age" name="age" min="0" max="120" />
            ...
            <div id="bmrcalc">
                ...
                <div className="form">
                    ...
                    <div className="inputwrap">
                        ...
                        <label><input type="radio" chechked={this.state.calculationType === "imperial"} onChange={this.handleCalculationChange} name="calcType" value="imperial" />Imperial</label>
                        <label><input type="radio" chechked={this.state.calculationType === "metric"} onChange={this.handleCalculationChange} name="calcType" value="metric" />Metric</label>
                    </div>
